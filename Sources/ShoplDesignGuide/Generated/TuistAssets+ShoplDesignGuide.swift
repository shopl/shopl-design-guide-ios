...
public extension SDG.Image {
    ...
    static let emptyData = SDG.Image(name: "empty_data", bundle: dsBundle)
    static let emptyMember = SDG.Image(name: "empty_member", bundle: dsBundle)
    static let emptySearch = SDG.Image(name: "empty_search", bundle: dsBundle)
    static let icAddPlus = SDG.Image(name: "ic_add_plus", bundle: dsBundle)
    static let icAlignBold = SDG.Image(name: "ic_align_bold", bundle: dsBundle)
    ...
    static let icAllbold = SDG.Image(name: "ic_allbold", bundle: dsBundle)
    static let icBan = SDG.Image(name: "ic_ban", bundle: dsBundle)
    ...
    static let icCommonChecksolid = SDG.Image(name: "ic_common_checksolid", bundle: dsBundle)
    static let icCommonCircleS = SDG.Image(name: "ic_common_circle_s", bundle: dsBundle)
    static let icCommonCircleXs = SDG.Image(name: "ic_common_circle_xs", bundle: dsBundle)
    ...
    static let icCommonDropdownS = SDG.Image(name: "ic_common_dropdown_s", bundle: dsBundle)
    ...
    static let icCommonMinus = SDG.Image(name: "ic_common_minus", bundle: dsBundle)
    static let icCommonMore = SDG.Image(name: "ic_common_more", bundle: dsBundle)
    ...
    static let icCommonPhoto = SDG.Image(name: "ic_common_photo", bundle: dsBundle)
    static let icCommonPlay = SDG.Image(name: "ic_common_play", bundle: dsBundle)
    static let icCommonPosition = SDG.Image(name: "ic_common_position", bundle: dsBundle)
    ...
    static let icCommonRequired = SDG.Image(name: "ic_common_required", bundle: dsBundle)
    static let icCommonRest = SDG.Image(name: "ic_common_rest", bundle: dsBundle)
    static let icCommonSchedule = SDG.Image(name: "ic_common_schedule", bundle: dsBundle)
    static let icCommonSearch = SDG.Image(name: "ic_common_search", bundle: dsBundle)
    static let icCommonSignal = SDG.Image(name: "ic_common_signal", bundle: dsBundle)
    ...
    static let icCommonWifi = SDG.Image(name: "ic_common_wifi", bundle: dsBundle)
    ...
    static let icEtcArrow = SDG.Image(name: "ic_etc_arrow", bundle: dsBundle)
    static let icEtcFilter = SDG.Image(name: "ic_etc_filter", bundle: dsBundle)
    static let icEtcPincheck = SDG.Image(name: "ic_etc_pincheck", bundle: dsBundle)
    static let icEtcWorkplaceadd = SDG.Image(name: "ic_etc_workplaceadd", bundle: dsBundle)
    ...
    static let icGradeEmpty = SDG.Image(name: "ic_grade_empty", bundle: dsBundle)
    ...
    static let icMenuInventory = SDG.Image(name: "ic_menu_inventory", bundle: dsBundle)
    static let icMenuMember = SDG.Image(name: "ic_menu_member", bundle: dsBundle)
    static let icMenuPrice = SDG.Image(name: "ic_menu_price", bundle: dsBundle)
    static let icMenuSales = SDG.Image(name: "ic_menu_sales", bundle: dsBundle)
    static let icMenuWorkplace = SDG.Image(name: "ic_menu_workplace", bundle: dsBundle)
    static let icMonth = SDG.Image(name: "ic_month", bundle: dsBundle)
    static let icMore = SDG.Image(name: "ic_more", bundle: dsBundle)
    ...
    static let icNaviLink = SDG.Image(name: "ic_navi_link", bundle: dsBundle)
    ...
    static let icNaviTemporary = SDG.Image(name: "ic_navi_temporary", bundle: dsBundle)
    static let icNetwork = SDG.Image(name: "ic_network", bundle: dsBundle)
    static let icOrganization = SDG.Image(name: "ic_organization", bundle: dsBundle)
    ...
    static let icTypeActiveMember = SDG.Image(name: "ic_type_active_member", bundle: dsBundle)
    static let icTypeBarcode = SDG.Image(name: "ic_type_barcode", bundle: dsBundle)
    static let icTypeBrand = SDG.Image(name: "ic_type_brand", bundle: dsBundle)
    static let icTypeCamera = SDG.Image(name: "ic_type_camera", bundle: dsBundle)
    static let icTypeChecklist = SDG.Image(name: "ic_type_checklist", bundle: dsBundle)
    static let icTypeCustomDropdown = SDG.Image(name: "ic_type_custom_dropdown", bundle: dsBundle)
    static let icTypeDate = SDG.Image(name: "ic_type_date", bundle: dsBundle)
    static let icTypeDisributor = SDG.Image(name: "ic_type_disributor", bundle: dsBundle)
    static let icTypeDocument = SDG.Image(name: "ic_type_document", bundle: dsBundle)
    static let icTypeDropdown = SDG.Image(name: "ic_type_dropdown", bundle: dsBundle)
    static let icTypeDuration = SDG.Image(name: "ic_type_duration", bundle: dsBundle)
    static let icTypeGridtext = SDG.Image(name: "ic_type_gridtext", bundle: dsBundle)
    static let icTypeMember = SDG.Image(name: "ic_type_member", bundle: dsBundle)
    static let icTypeMulti = SDG.Image(name: "ic_type_multi", bundle: dsBundle)
    static let icTypeMultitext = SDG.Image(name: "ic_type_multitext", bundle: dsBundle)
    static let icTypePeriod = SDG.Image(name: "ic_type_period", bundle: dsBundle)
    static let icTypePhoto = SDG.Image(name: "ic_type_photo", bundle: dsBundle)
    static let icTypeRadio = SDG.Image(name: "ic_type_radio", bundle: dsBundle)
    static let icTypeScan = SDG.Image(name: "ic_type_scan", bundle: dsBundle)
    static let icTypeSign = SDG.Image(name: "ic_type_sign", bundle: dsBundle)
    static let icTypeSingletext = SDG.Image(name: "ic_type_singletext", bundle: dsBundle)
    static let icTypeText = SDG.Image(name: "ic_type_text", bundle: dsBundle)
    static let icTypeTime = SDG.Image(name: "ic_type_time", bundle: dsBundle)
    static let icTypeVideo = SDG.Image(name: "ic_type_video", bundle: dsBundle)
    ...
    static let mapMypin = SDG.Image(name: "map_mypin", bundle: dsBundle)
    static let mapPin = SDG.Image(name: "map_pin", bundle: dsBundle)
